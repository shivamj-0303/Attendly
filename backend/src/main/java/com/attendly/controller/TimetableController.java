...
public class TimetableController {
  ...
  public ResponseEntity<List<TimetableSlotResponse>> getSlotsByClass(
    ...
    List<TimetableSlotResponse> slots =
        timetableService.getSlotsByClass(classId, userPrincipal.getId());
  ...
  public ResponseEntity<List<TimetableSlotResponse>> getSlotsByClassAndDay(
      ...
      @AuthenticationPrincipal UserPrincipal userPrincipal) {
    List<TimetableSlotResponse> slots =
        timetableService.getSlotsByClassAndDay(classId, dayOfWeek, userPrincipal.getId());
    return ResponseEntity.ok(slots);
  }
  ...
  public ResponseEntity<TimetableSlotResponse> updateSlot(
      ...
      @Valid @RequestBody TimetableSlotRequest request,
      @AuthenticationPrincipal UserPrincipal userPrincipal) {
    TimetableSlotResponse response =
        timetableService.updateSlot(id, request, userPrincipal.getId());
