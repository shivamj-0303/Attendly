...
public interface AttendanceRepository extends JpaRepository<Attendance, Long> {
  ...
  Optional<Attendance> findByTimetableSlotIdAndStudentIdAndDate(
      Long timetableSlotId, Long studentId, LocalDate date);

  List<Attendance> findByStudentIdAndDateBetween(
      Long studentId, LocalDate startDate, LocalDate endDate);

  List<Attendance> findByTimetableSlotIdAndDateBetween(
      Long timetableSlotId, LocalDate startDate, LocalDate endDate);
}
