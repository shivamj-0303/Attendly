  ...
  public Teacher createTeacher(TeacherRequest request, Long adminId) {
    ...
    if (generated) {
      ...
      String html = String.format(
          "<p>Hello %s,</p><p>Your teacher account has been created. Use the following temporary password to sign in:</p><p><strong>%s</strong></p><p>You can change this password anytime using the password reset feature.</p>",
